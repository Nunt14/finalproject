...
const translations: Dictionary = {
  ...
  'forgot.email_required': { TH: 'กรุณากรอกอีเมล', EN: 'Please enter your email' },
  'forgot.password_required': { TH: 'กรุณากรอกรหัสผ่านใหม่ทั้งสองช่อง', EN: 'Please enter new password in both fields' },
  'forgot.password_mismatch': { TH: 'รหัสผ่านไม่ตรงกัน', EN: 'Passwords do not match' },
  'forgot.password_too_short': { TH: 'รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร', EN: 'Password must be at least 6 characters' },
  'forgot.please_login_first': { TH: 'กรุณาเข้าสู่ระบบก่อน', EN: 'Please log in first' },
  'forgot.login_first_message': { TH: 'เพื่อความปลอดภัย กรุณาเข้าสู่ระบบด้วยรหัสผ่านเก่าก่อน แล้วไปที่หน้าโปรไฟล์เพื่อเปลี่ยนรหัสผ่าน', EN: 'For security, please log in with your old password first, then go to the profile page to change your password' },
  'forgot.reset_error': { TH: 'ไม่สามารถรีเซ็ตรหัสผ่านได้ กรุณาติดต่อผู้ดูแลระบบ', EN: 'Unable to reset password. Please contact administrator' },
  'forgot.reset_link_sent_title': { TH: 'ส่งลิงก์เรียบร้อย', EN: 'Reset link sent' },
  'forgot.reset_link_sent_message': { TH: 'เราได้ส่งลิงก์รีเซ็ตรหัสผ่านไปที่ {email}', EN: 'We have sent a password reset link to {email}' },
  'forgot.open_mail': { TH: 'เปิดอีเมล', EN: 'Open Mail' },
  'forgot.processing': { TH: 'กำลังดำเนินการ...', EN: 'Processing...' },
